...
const Tours = () => {
  ...
  return (
    <div className='relative py-14 lg:px-28 sm:px-12 px-0 bg-black'>
      <div ref={ref} className="flex md:flex-row flex-col justify-center lg:gap-36 md:gap-24 gap-10 items-center">
        ...
        <div className="flex flex-col justify-center items-start">
           ...
           <motion.div className="md:w-[487px] w-full border-t border-b border-[#CFB8B8] flex justify-between items-center py-5" initial={{ opacity: 0, y: 20 }} animate={{ opacity: inView ? 1 : 0, y: inView ? 0 : 20 }}>
           ...
           <motion.div className="md:w-[487px] w-full   border-b border-[#CFB8B8] flex justify-between items-center py-5" initial={{ opacity: 0, y: 20 }} animate={{ opacity: inView ? 1 : 0, y: inView ? 0 : 20 }}>
              <div className="text-[#C1BFBF]">
                <p>The Forum</p>
                <p>Los Angeles, CA</p>
              </div>
